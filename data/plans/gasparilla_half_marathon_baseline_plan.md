...
- **A-Goal (Stretch):** Sub 1:50:00 (8:24/mile pace)
- **B-Goal (Target):** Sub 1:52:00 (8:33/mile pace)
- **C-Goal (Minimum):** Sub 1:54:00 (8:42/mile pace)

**Previous Performance:** 1:55:04 (Gasparilla 2025, 8:46/mile)
**Target Improvement:** 3-5 minutes

---

## Current Fitness Status (Dec 1, 2025)

**Post-Marathon Status (Nov 23, 2025 - Central Florida Legends Skunk Ape Marathon):**
- Finish: 4:35:49 (10:24/mile pace)
- Avg HR: 163 bpm, Max HR: 175 bpm
- Days post-race: 8 days

**Current Metrics:**
- **VDOT:** 43.7
- **VO2 Max:** 50.6 ml/kg/min
- **Weight:** 170.1 lbs
- **Resting HR:** 45 bpm avg
...
| Zone | Pace | HR Target | Purpose |
|------|------|-----------|---------|
| **Easy (E)** | 10:04-10:48/mile | <145 bpm | Recovery, aerobic base |
| **Marathon (M)** | 9:10/mile | 150-160 bpm | Lactate threshold foundation |
| **Tempo (T)** | 8:27/mile | 160-170 bpm | Lactate clearance |
| **Interval (I)** | 7:55/mile | 170-180 bpm | VO2 max development |
| **Repetition (R)** | 7:30/mile | Max effort | Speed, economy |

**Half Marathon Race Paces:**
- A-Goal: 8:24/mile (stretch)
- B-Goal: 8:33/mile (target)
- C-Goal: 8:42/mile (conservative)
...
- **Mobility:** 10 min post-run routine (foam roll + calf/hamstring stretches)

#### Thursday, Dec 11
- **Running:** REST or 20 min easy walk
- **Mobility:** 10 min light mobility (hip circles, leg swings, gentle stretches)

#### Friday, Dec 12
- **Running:** 30 min Easy + 4 strides (20 sec pickups, easy recovery)
- **Strength:** REST - no strength this week
...
- **Strength:** PRIMARY Session #1 - Lower Body + Core (45-50 min)
  - Warmup: 10 min (bike/walk, hip circles, leg swings, bodyweight squats)
  - A1. Goblet Squat: 3 × 12-15 reps
  - A2. Single-Leg RDL: 3 × 10-12 per leg
  - B1. Bulgarian Split Squat: 3 × 10-12 per leg
...
- **Mobility:** 10 min post-run routine (foam roll + stretches)

#### Thursday, Dec 18
- **Running:** 35 min Easy with 6 strides at end (20 sec pickups)
- **Mobility:** 10 min post-run routine (focus: calves, hamstrings)

#### Friday, Dec 19
- **Running:** REST (light strength day)
- **Strength:** LIGHT Session #1 - Upper Body + Core (30-35 min)
  - Warmup: 5 min easy movement
  - A1. Bent-Over Row (dumbbells): 3 × 12-15 reps
  - A2. Goblet Squat (light): 3 × 12 reps
  - B1. Dead Bug: 3 × 10 per side
  - B2. Bird Dog: 3 × 10 per side
  - C1. Glute Bridge: 3 × 15 reps
  - C2. Standing Calf Raise: 3 × 20 reps
...
#### Tuesday, Dec 23
- **Running:** REST (strength day)
- **Strength:** PRIMARY Session #2 - Lower Body + Core (45-50 min)
  - Warmup: 10 min
  - A1. Goblet Squat: 3 × 12-15 reps (slight load increase from last week)
  - A2. Single-Leg RDL: 3 × 10-12 per leg
  - B1. Walking Lunge: 3 × 12 per leg
...
- **Running:** REST or 20-30 min easy social run
- **Mobility:** 10 min light mobility

#### Friday, Dec 26
- **Running:** REST (light strength day)
- **Strength:** LIGHT Session #2 - Upper Body + Core (30-35 min)
  - Warmup: 5 min
  - A1. Bent-Over Row: 3 × 12-15 reps
  - A2. Step-Up: 3 × 10 per leg
  - B1. Dead Bug: 3 × 12 per side
  - B2. Quadruped Hip Extension: 3 × 12 per side
  - C1. Glute Bridge (single-leg): 3 × 10 per leg
  - C2. Calf Raise: 3 × 20 reps
- **Mobility:** 10 min evening mobility
...
#### Tuesday, Dec 30
- **Running:** REST (strength day)
- **Strength:** PRIMARY Session #3 - Lower Body + Core (45-50 min)
  - Warmup: 10 min
  - A1. Goblet Squat: 3 × 12-15 reps
  - A2. Single-Leg RDL: 3 × 10-12 per leg
  - B1. Bulgarian Split Squat: 3 × 10-12 per leg
...
- **Running:** REST or 30 min easy celebration run
- **Mobility:** 10 min light mobility

#### Friday, Jan 2
- **Running:** REST (light strength day)
- **Strength:** LIGHT Session #3 - Upper Body + Core (30-35 min)
  - Warmup: 5 min
  - A1. Bent-Over Row: 3 × 12-15 reps
  - A2. Goblet Squat: 3 × 12 reps
  - B1. Dead Bug (with leg extension): 3 × 12 per side
  - B2. Bird Dog (with hold): 3 × 10 per side (3 sec hold)
  - C1. Glute Bridge (single-leg): 3 × 12 per leg
  - C2. Calf Raise: 3 × 20 reps
- **Mobility:** 10 min evening mobility
...
- **Running:** REST (strength day)
- **Strength:** PRIMARY Session #4 - Lower + Core (45-50 min)
  - Move to 8-12 rep range, increased load
  - Warmup: 10 min
  - A1. Goblet Squat: 4 × 8-10 reps (heavier)
  - A2. Single-Leg RDL: 4 × 8-10 per leg (heavier)
  - B1. Bulgarian Split Squat: 3 × 10 per leg
...
#### Thursday, Jan 8
- **Running:** 40 min Progression Run (work fitness time ~0715)
  - 10 min Easy warmup
  - 20 min build from E pace to M pace (finish at 9:10/mile)
  - 10 min Easy cooldown
- **Mobility:** 10 min post-run routine (focus: legs, gentle stretching)

#### Friday, Jan 9
- **Running:** REST (light strength day)
- **Strength:** LIGHT Session #4 - Upper + Core (30-35 min)
  - Warmup: 5 min
  - A1. Bent-Over Row: 3 × 10-12 reps
  - A2. Step-Up (tempo): 3 × 8 per leg
  - B1. Dead Bug (extended): 3 × 12 per side
  - B2. Bird Dog (opposite reach): 3 × 10 per side
  - C1. Single-Leg Glute Bridge: 3 × 12 per leg
  - C2. Calf Raise: 3 × 20 reps
- **Mobility:** 10 min evening mobility
...
#### Tuesday, Jan 13
- **Running:** REST (strength day)
- **Strength:** PRIMARY Session #5 - Lower + Core (45-50 min)
  - Warmup: 10 min
  - A1. Goblet Squat: 4 × 8-10 reps
  - A2. Single-Leg RDL: 4 × 8-10 per leg
  - B1. Walking Lunge (weighted): 3 × 12 per leg
...
#### Thursday, Jan 15
- **Running:** TEMPO WORKOUT #1 (work fitness time)
  - 10 min Easy warmup
  - 2 × 8 min at T pace (8:27/mile, HR 160-170 bpm)
  - 3 min Easy recovery jog between reps
  - 10 min Easy cooldown
  - **Total:** 45 min
- **Mobility:** 12 min post-run routine (extra recovery attention)

#### Friday, Jan 16
- **Running:** REST (light strength day)
- **Strength:** LIGHT Session #5 - Upper + Core (30-35 min)
  - Warmup: 5 min
  - A1. Bent-Over Row: 3 × 10-12 reps
  - A2. Goblet Squat (light): 3 × 10 reps
  - B1. Dead Bug: 3 × 12 per side
  - B2. Bird Dog: 3 × 10 per side
  - C1. Single-Leg Glute Bridge: 3 × 12 per leg
  - C2. Calf Raise: 3 × 20 reps
...
#### Tuesday, Jan 20
- **Running:** REST (strength day)
- **Strength:** PRIMARY Session #6 - Lower + Core (45-50 min)
  - Warmup: 10 min
  - A1. Goblet Squat: 4 × 8-10 reps
  - A2. Single-Leg RDL: 4 × 8-10 per leg
  - B1. Bulgarian Split Squat: 3 × 10 per leg
...
#### Thursday, Jan 22
- **Running:** TEMPO WORKOUT #2 (work fitness time)
  - 10 min Easy warmup
  - 3 × 7 min at T pace (8:27/mile, HR 160-170)
  - 2.5 min Easy recovery between reps
  - 10 min Easy cooldown
  - **Total:** 46 min
...
#### Friday, Jan 23
- **Running:** REST (light strength day)
- **Strength:** LIGHT Session #6 - Upper + Core (30-35 min)
  - Warmup: 5 min
  - A1. Bent-Over Row: 3 × 10-12 reps
  - A2. Step-Up: 3 × 8 per leg
  - B1. Dead Bug (extended): 3 × 12 per side
  - B2. Bird Dog (with hold): 3 × 10 per side
  - C1. Single-Leg Glute Bridge: 3 × 12 per leg
  - C2. Calf Raise: 3 × 20 reps
- **Mobility:** 10 min evening mobility
...
- **Strength:** PRIMARY Session #7 - Maintenance (35-40 min)
  - Warmup: 8 min
  - A1. Goblet Squat: 3 × 8 reps (maintain load, reduce volume)
...
- **Mobility:** 12 min evening PTT session (extra attention with increased running load)
...
#### Thursday, Jan 29
- **Running:** TEMPO WORKOUT #3 (work fitness time)
  - 10 min Easy warmup
  - 20 min continuous at T pace (8:27/mile, HR 160-170)
  - 10 min Easy cooldown
  - **Total:** 40 min
- **Mobility:** 12 min post-run routine

#### Friday, Jan 30
- **Running:** 30 min Easy recovery (light effort)
- **Strength:** LIGHT Session #7 - Minimal (20-25 min)
  - Warmup: 5 min
...
#### Tuesday, Feb 3
- **Running:** REST (strength day)
- **Strength:** PRIMARY Session #8 - Maintenance (35-40 min)
  - Warmup: 8 min
  - A1. Goblet Squat: 3 × 8 reps
  - A2. Single-Leg RDL: 3 × 8 per leg
  - B1. Walking Lunge: 2 × 10 per leg
  - B2. Side Plank: 2 × 30 sec per side
  - C1. Pallof Press: 2 × 10 per side
  - C2. Eccentric Calf: 2 × 10 per leg
...
#### Thursday, Feb 5
- **Running:** HALF MARATHON PACE WORKOUT (work fitness time)
  - 10 min Easy warmup
  - 2 × 12 min at B-goal HM pace (8:33/mile, HR 155-165)
  - 3 min Easy recovery jog between reps
  - 10 min Easy cooldown
  - **Total:** 47 min
  - **Purpose:** Practice race pace, assess readiness
- **Mobility:** 12 min post-run routine

#### Friday, Feb 6
- **Running:** 25 min Easy recovery (very light)
- **Strength:** LIGHT Session #8 - Minimal (20-25 min)
  - Warmup: 5 min
  - A1. Bent-Over Row: 2 × 10 reps
  - A2. Step-Up: 2 × 8 per leg
  - B1. Dead Bug: 2 × 10 per side
  - B2. Single-Leg Glute Bridge: 2 × 10 per leg
  - C1. Calf Raise: 2 × 15 reps
- **Mobility:** 10 min evening mobility
...
#### Wednesday, Feb 18
- **Running:** REST or 20 min very easy jog (optional)
...
- **Running:** RACE PREP WORKOUT (work fitness time)
  ...
  - 10 min Easy cooldown
  - **Total:** 25 min
  - **Purpose:** Activate legs, practice race speed feel
- **Mobility:** 10 min gentle post-run routine

#### Friday, Feb 20
- **Running:** REST (full rest 2 days before race)
- **Strength:** NO STRENGTH
- **Mobility:** 15 min gentle stretching + PTT drills (keep relaxed)

#### Saturday, Feb 21
- **Running:** 20 min Easy shakeout + 4 × 20 sec pickups
  - Very light effort, just activate legs
...
- **RACE:** Publix Gasparilla Distance Classic Half Marathon
  ...
  - **Strategy:**
    - Start controlled at 8:30-8:35/mile
    - Assess at mile 6-7
    - Push final 5K if feeling strong
...
## Wrist Constraint - Exercise Alternatives Reference

**CANNOT DO (wrist pressure):**
- Push-ups, planks (front-loaded), burpees, handstands, front carries

**ALTERNATIVES TO USE:**

**Core Work:**
- Forearm planks (NOT hand planks)
...
- Rows (all variations)
- Pull-ups/chin-ups
- Goblet holds (weight at chest)
- Back-loaded carries (rucking, weighted vests)
...
## PTT (Posterior Tibialis Tendinopathy) Daily Protocol

**Essential Exercises (10-15 min daily):**

1. **Towel Scrunches:** 3 × 15 reps per foot
2. **Single-Leg Eccentric Heel Raises:** 3 × 8-10 per leg (3-5 sec lower)
3. **Toe Yoga:** 2 × 10 reps per foot
4. **Banded Ankle Inversions:** 3 × 15 reps per foot
5. **Standing Arch Doming:** 6 × 10 sec holds per foot

**Frequency:** Daily, every day of the plan
**Timing:** Evening preferred, or post-run on run days
**Purpose:** Prevent PTT flare-ups, maintain foot/ankle health

---

## Adjustment Guidelines

**If Sleep <6 hours or quality <50:**
- Convert quality runs to easy runs
- Reduce long run by 10-15 min
- Keep easy pace at upper end of range (10:30-10:48/mile)
- Add 5-10 min to warmup

**If Resting HR elevated >5 bpm above baseline (45 bpm):**
- Take extra rest day
- Convert next run to easy effort
- Monitor for illness/overtraining

**If PTT symptoms appear (medial ankle pain):**
- Reduce running volume by 30%
- Increase PTT drills to 2x daily
- Avoid hills and speed work until resolved
- Consider shoes with more arch support

**If strength soreness interferes with running:**
- Reduce strength volume by 25%
- Focus on single-leg work with lighter loads
- Ensure 48 hrs between strength and quality runs

---

## Nutrition Notes (Gluten-Free, Dairy-Free)

**Daily Fueling:**
- Adequate protein: 0.7-0.8g per lb bodyweight (~120-135g/day)
- Carbs around training: Pre-run fuel, post-run recovery
- Hydration: 0.5-0.7 oz per lb bodyweight (~85-120 oz/day)

**Pre-Run (1-2 hrs before):**
- Easy carbs: banana, GF toast with almond butter, dates
- Small amount of protein if >2 hrs

**Post-Run (within 30-60 min):**
- Carb + protein combo: smoothie with protein powder, GF oats with nuts

**Race Day Fueling:**
- Breakfast 2-3 hrs before: familiar GF/DF meal
- During race: Water at aid stations
- Post-race: Recovery meal within 60 min
...
**Weekly Check-ins:**
- How did paces feel? (too easy, just right, too hard)
- Sleep quality and duration
- Resting HR trends
- PTT status
- Energy levels

**VDOT Reassessment Triggers:**
- Tempo runs consistently feel easy for 2+ weeks → may be ready for pace increase
- Struggling with prescribed paces despite good sleep/recovery → may need conservative adjustment
- Race performance → recalculate VDOT after Feb 22 race

**Post-Race Actions (Feb 23+):**
1. Calculate new VDOT from race performance
2. Update current_training_status.md
3. Begin recovery phase (1-2 weeks easy running)
...
1. **Consistency over intensity** - showing up for easy runs matters more than crushing workouts
2. **Respect the taper** - trust the training, resist urge to add volume in final weeks
3. **Sleep prioritization** - 7+ hrs/night, especially before quality sessions
4. **PTT daily attention** - 10-15 min every day prevents issues
5. **Pace discipline** - easy runs EASY (10:04-10:48), tempo at prescribed T pace
6. **Strength supports running** - never sacrifice running quality for strength gains
7. **Listen to your body** - adjust when needed, conservative approach prevents injury

---

## Questions or Concerns?

**During training, consult coaches if:**
- Paces feel significantly off (too easy/hard) for 2+ consecutive weeks
- Injury symptoms appear or persist >3 days
- Sleep disruption significantly affects training ability
- Major life events require schedule adjustments

**Race week support:**
- Pacing strategy questions
- Fueling plan refinement
- Taper anxiety (normal!) - trust the plan
- Weather-adjusted strategy

---

**This is your baseline plan. Coaches can adjust based on your feedback, recovery data, and progress. The plan is designed to be flexible while maintaining the core training principles. Good luck with your training, and we'll see you at the finish line in Tampa!**
